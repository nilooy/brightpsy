import StarReviews from "@ui/components/Basic/StarReviews";
import React from "react";
const Reviews = () => {
  return (
    <>
      <div className="flex items-center justify-center py-8 text-left">
        <div className="bg-white w-full rounded px-5 py-5 shadow">
          ...
          <div className="mt-6">
            <div className="flex items-start justify-between">
              <div className="flex items-start">
                ...
                />
                <div className="ml-3">
                  <p className="text-sm leading-4 text-gray-800 font-semibold">
                    Mike Scarn
                  </p>
                  <p className="text-xs leading-3 text-gray-600 mt-1">
                    Marketing Manager, IMC
                  </p>
                  <p className="text-sm leading-4 text-gray-800 my-3">
                    Incredible job and outstanding work
                  </p>
                  <p className="text-xs leading-3 text-gray-500">6 days ago</p>
                </div>
              </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm leading-5 text-gray-800 my-3">
                  ...
                  <p className="text-xs leading-3 text-gray-500">10 days ago</p>
                </div>
              </div>
              <div className="flex items-center">
                <svg
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm leading-4 text-gray-800 my-3 w-10/12">
